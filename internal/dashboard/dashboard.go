...
<main>
  ...
  <section class="layout">
    <div class="left-col">
      ...
      <div class="card">
        <div class="curve-head" style="margin-bottom:8px;"><h3 style="margin:0">风扇曲线配置</h3><span class="muted" id="curveValues"></span></div>
